...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* reexport */ SectionExample_SectionExample; });
...
// CONCATENATED MODULE: ./src/views/Documentation/examples/SectionExample/SectionExample.js
...
const SectionExample = (_ref) => {
  ...
  return __jsx("div", rest, __jsx(components["e" /* SectionBox */], {
    ...
    borderRadius: "4px"
  }, __jsx(organisms["t" /* Section */], null, __jsx(core_["Typography"], null, "This is section with default padding"))), __jsx(components["a" /* CodeHighlighter */], {
    code: exampleCode
  }))));
};

/* harmony default export */ var SectionExample_SectionExample = (SectionExample);
// CONCATENATED MODULE: ./src/views/Documentation/examples/SectionExample/index.js
