...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* reexport */ ParallaxExample_ParallaxExample; });
...
// CONCATENATED MODULE: ./src/views/Documentation/examples/ParallaxExample/ParallaxExample.js
...
const ParallaxExample = (_ref) => {
  ...
  return __jsx("div", rest, __jsx(components["e" /* SectionBox */], {
    ...
    }, "Use flexible components.", __jsx("br", null), __jsx(core_["Typography"], {
      component: "span",
      variant: "inherit",
      color: "primary"
    }, "to build an app quickly.")),
...
/* harmony default export */ var ParallaxExample_ParallaxExample = (ParallaxExample);
// CONCATENATED MODULE: ./src/views/Documentation/examples/ParallaxExample/index.js
