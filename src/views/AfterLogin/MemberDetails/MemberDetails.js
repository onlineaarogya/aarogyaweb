...
function MemberDetails() {
  ...
  const clickMe = () => {
    setAnchorEl(<div style={{fontSize:"12px"}}>   
     <Menu  id="simple-menu"  anchorEl={anchorEl} keepMounted open={Boolean(anchorEl)} onClose={handleClose} style={{width:"200px",marginLeft:"100px",marginTop:"110px"}}>
       <List>
        <ListItem style={{height:"40px"}}>
        <WhatsAppIcon className={classes.icon}  style={{color:"green"}}/> 
         <Button variant="raised" color="primary">  WhatsApp </Button>
       </ListItem>
